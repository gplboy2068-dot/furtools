...
export const ENRICHED_DOG_TOOLS: Record<string, EnrichedToolContent> = {
  ...
  "dog-size-predictor": {
    "howItWorks": "### Specialist Guide: Canine Pediatric Auxology, Gompertz Growth Kinetics & Adult Size Prediction\n\nPredicting a puppy's adult body dimensions is one of the most clinically relevant assessments in veterinary pediatric practice. Determining whether an 8-week-old puppy will mature into a 35-pound compact companion or a 75-pound large working dog dictates foundational decisions regarding **pediatric caloric density, skeletal calcium-to-phosphorus ratios, epiphyseal growth plate protection, crate dimensions, and the timing of elective gonadectomy (spay/neuter)**.\n\nUnlike human growth, which features prolonged childhood followed by an adolescent growth spurt, domestic dogs (*Canis lupus familiaris*) exhibit an accelerated, **sigmoidal (S-shaped) Gompertz growth trajectory**. Allometric canine growth curves demonstrate that mature body mass is governed by breed somatotype categories.\n\n---\n\n#### 1. Somatotype Growth Divergence Across Breeds\nCanines display the greatest morphological diversity of any terrestrial mammal, spanning a 40-fold weight difference between mature adults:\n- **Toy & Miniature Breeds (< 12 lbs / 5.5 kg):** Experience explosive early development. Toy puppies reach 50% of their adult weight by 10 to 12 weeks of age and achieve 95% to 100% of final skeletal maturity by **8 to 10 months**.\n- **Small Breeds (12–25 lbs / 5.5–11 kg):** Reach the 50% inflection midpoint around 14 to 16 weeks, plateauing in skeletal height by **10 to 12 months**.\n- **Medium Breeds (26–50 lbs / 12–23 kg):** Follow a steady trajectory, reaching 50% of adult mass at 16 to 18 weeks (roughly 4 months) and completing structural bone growth by **12 to 14 months**.\n- **Large Breeds (51–85 lbs / 23–39 kg):** Exhibit an extended juvenile growth window. They achieve 50% of adult weight around 20 to 22 weeks (5 months) and continue skeletal expansion and thoracic deepening until **14 to 18 months**.\n- **Giant Breeds (> 85 lbs / 39–70+ kg):** Possess the longest developmental arc. Giant puppies do not reach their halfway mark until 24 to 26 weeks (6 months) and continue building skeletal density, bone mineral content, and muscle mass up to **20 to 24 months**.\n\n---\n\n#### 2. The Science of Epiphyseal Growth Plates & Exercise Restrictions\nLong bones (such as the femur, tibia, humerus, and radius) elongate from specialized cartilaginous zones called **epiphyseal plates (physis)** located near bone terminals:\n1. **Vulnerability to Shear Micro-Trauma:** During peak velocity growth (ages 2 to 7 months), unmineralized cartilage is significantly softer than surrounding cortical bone. High-impact jumping off beds, agility weave poles, repetitive ball chasing on hard pavement, or sustained forced running can fracture or crush the physis (Salter-Harris fractures), causing premature plate closure and permanent angular limb deformities.\n2. **The 5-Minute Rule:** A widely accepted veterinary sports medicine guideline is **5 minutes of structured walking per month of age, up to twice daily** (e.g., a 4-month-old puppy should walk no more than 20 minutes continuously).\n\n---\n\n#### 3. Large Breed Nutritional Management: The Calcium Paradox\nIn puppies projected to exceed 50 lbs as adults, **maximizing growth velocity is dangerous**:\n- Excess calories and unrestricted calcium trigger **Developmental Orthopedic Diseases (DOD)**, including hip dysplasia, elbow dysplasia, osteochondritis dissecans (OCD), and hypertrophic osteodystrophy (HOD).\n- Large-breed puppies cannot regulate intestinal calcium absorption efficiently before 6 months of age. Feeding a diet with excess calcium (> 1.5% dry matter) leads to hypercalcemia, delayed cartilage maturation, and osteochondrosis.\n- Always feed an **AAFCO-certified Large Breed Growth formula** maintaining calcium between 0.8% and 1.2% on a dry-matter basis.\n\nCalculate nutritional feeding grams using our [Dog Food Calculator](/tools/dog-food-calculator), monitor body condition scores via the [Dog BMI Calculator](/tools/dog-bmi-calculator), plan appropriate exercise limits with the [Dog Walking Calculator](/tools/dog-walking-calculator), and ensure crate comfort via the [Dog Crate Size Calculator](/tools/dog-crate-size-calculator). Explore canine pediatric guidelines through the [American Animal Hospital Association (AAHA)](https://www.aaha.org) and [WSAVA Global Nutrition Committee](https://wsava.org).",
    "faqs": [
      {
        "q": "How accurate is predicting a puppy's adult weight at 16 weeks?",
        "a": "For medium and large dogs, the 16-week (4-month) benchmark is clinically reliable. For most medium breeds, adult weight is approximately double their 16-week weight (± 8%). For toy breeds, doubling weight occurs earlier at 10 to 12 weeks, while giant breeds reach their halfway mark closer to 24 weeks."
      },
      {
        "q": "Do big paws really mean a puppy will be a huge dog?",
        "a": "Paw size provides a helpful general indicator of skeletal bone stock and joint width, especially in mixed-breed puppies. Puppies with heavy bone density, broad wrists (carpals), and loose skin typically grow into medium-to-large adults. However, disproportionately large paws occasionally reflect breed-specific traits (such as Basset Hounds or Bulldogs) rather than excessive overall height."
      },
      {
        "q": "When do puppies stop growing in height versus weight?",
        "a": "Puppies achieve their final shoulder (wither) height first—typically between 8 to 12 months for small/medium dogs and 12 to 15 months for large dogs. After height growth stops, canines enter the 'filling out' phase, broadening the chest and gaining lean muscle mass for an additional 3 to 9 months."
      },
      {
        "q": "Why should I avoid rapid growth in large breed puppies?",
        "a": "Rapid weight gain stresses immature cartilage and open growth plates before bones have fully mineralized. Research proves that puppies grown at a controlled, lean rate develop significantly lower rates and severity of hip and elbow dysplasia without reducing their ultimate genetic adult size."
      },
      {
        "q": "How does early spaying or neutering affect a puppy's final adult size?",
        "a": "Gonadal hormones (estrogen and testosterone) signal epiphyseal growth plates to calcify and close. Neutering or spaying a dog before growth plates fuse (especially under 6 to 9 months in large breeds) delays plate closure, causing long leg bones to grow slightly longer. This can result in a taller, lankier dog with altered joint angulation."
      },
      {
        "q": "How do male and female dog adult sizes compare?",
        "a": "In small and toy breeds, sexual dimorphism is minimal (2% to 4% difference). In medium, large, and giant breeds, intact adult males are typically 8% to 15% heavier and 1 to 2 inches taller than females of the same litter."
      },
      {
        "q": "What should I do if my puppy's growth suddenly stalls?",
        "a": "Sudden growth plateaus or weight loss in puppies warrant veterinary evaluation. Common causes include gastrointestinal parasites (roundworms, Giardia, Coccidia), inadequate caloric density, systemic infections, or liver shunts. Your vet will perform a physical exam and fecal test."
      },
      {
        "q": "When is the right time to transition my puppy to adult dog food?",
        "a": "Small and medium breeds can transition to adult maintenance food between 10 and 12 months of age. Large and giant breeds should remain on specialized large-breed puppy formula until 14 to 18 months, when distal long-bone growth plates are confirmed closed."
      }
    ]
  },
