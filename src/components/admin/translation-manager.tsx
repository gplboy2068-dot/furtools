...
export function TranslationManager() {
  ...
  const [keyItems, setKeyItems] = useState<Record<string, KeyItem[]>>({
    ...
    home: [
      { key: 'heroTitle', defaultVal: 'Smart Care Tools for Happier, Healthier Pets', currentVal: '', status: 'Draft' },
      { key: 'heroDescription', defaultVal: 'From dog age conversion to personalized nutrition plans, access expert-designed calculators and AI care assistants.', currentVal: '', status: 'Draft' },
      { key: 'exploreTools', defaultVal: 'Explore Tools', currentVal: '', status: 'Draft' },
      { key: 'popularTools', defaultVal: 'Popular Tools', currentVal: '', status: 'Draft' },
      { key: 'featuredBreeds', defaultVal: 'Featured Breed Guides', currentVal: '', status: 'Draft' },
      { key: 'latestArticles', defaultVal: 'Latest Care Articles', currentVal: '', status: 'Draft' },
      { key: 'browseAllTools', defaultVal: 'Browse all {{count}}+ tools', currentVal: '', status: 'Draft' },
      { key: 'askAi', defaultVal: 'Ask AI', currentVal: '', status: 'Draft' },
      { key: 'searchTools', defaultVal: 'Search tools', currentVal: '', status: 'Draft' },
      { key: 'stats.freeTools', defaultVal: 'Free tools', currentVal: '', status: 'Draft' },
      { key: 'stats.aiAssistants', defaultVal: 'AI assistants', currentVal: '', status: 'Draft' },
      { key: 'stats.speciesCovered', defaultVal: 'Species covered', currentVal: '', status: 'Draft' },
      { key: 'categoriesHeading', defaultVal: 'Find the right tool for your pet', currentVal: '', status: 'Draft' },
      { key: 'everythingOnFurTools', defaultVal: 'Everything on FurTools', currentVal: '', status: 'Draft' },
      { key: 'exploreEveryHub', defaultVal: 'Explore every hub', currentVal: '', status: 'Draft' },
      { key: 'hubDescription', defaultVal: 'One platform for calculators, AI advice, breed research, food safety, name inspiration, cost planning, and end-to-end pet health records.', currentVal: '', status: 'Draft' },
      { key: 'aiSubheading', defaultVal: '{{count}} AI helpers — never diagnostic, always kind', currentVal: '', status: 'Draft' },
      { key: 'aiDescription', defaultVal: 'Ask about care, training, grooming, food safety, travel, or species-specific husbandry.', currentVal: '', status: 'Draft' },
      { key: 'breedHeading', defaultVal: '500+ breed profiles across every species', currentVal: '', status: 'Draft' },
      { key: 'browseAllBreeds', defaultVal: 'Browse all breeds →', currentVal: '', status: 'Draft' }
    ],
    tools: [
